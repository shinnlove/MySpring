 ...
 * @version $Id: SimpleMail.java, v 0.1 2017-12-31 下午11:00 shinnlove.jinsheng Exp $$
 */
public class SimpleMail {
    ...
    public static void main(String[] args) {
        ...
        try {
            out = new FileOutputStream("/Users/zhaochensheng/Downloads/MyEmail.eml");
            message.writeTo(out);
            out.flush();
            out.close();
