 ...
 * @version $Id: TestWeChatPay.java, v 0.1 2017-12-02 上午11:34 shinnlove.jinsheng Exp $$
 */
public class TestWeChatPay {
    ...
    public TestWeChatPay() throws Exception {
    ...
    public void testUnifiedOrderSpeed() throws Exception {
        TestWeChatPay dodo = new TestWeChatPay();
